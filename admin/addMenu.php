        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="menuName" placeholder="نام منو">
                </div>
                <?php $td = $db::Query("SELECT * FROM menus",$db::$NUM_ROW); ?>
                <div class="form-group">
                    <label for="exampleInputEmail1">جایگاه در نوار بالا</label>
                    <input type="number" class="form-control" id="pos" placeholder="نوع چیدمان" value="<?php echo "" .$td+1?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="image-editor" style="text-align: center;direction: ltr;">
                        ...
                        <a type="button" onclick="show_img()" class="btn btn-info "><i class="icon-plus"></i>اضافه کردن تصویر</a>
...
<script>
    ...
    function submit() {
        ...
        var pos = $("#pos").val();
        $.ajax({
            url:"request/addMenu.php",
            data:{
                menuName:menuName,
                pos:pos,
                menuImgUrl:imgprofile
            },
            dataType:"json",
            type:"POST",
