...
$query = $db::Query("select * from color WHERE colorId='$id'");
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">ویرایش رنگها</label>
                    <input type="color" class="form-control" id="colorName" placeholder="ویرایش رنگها" value="<?php echo $fetched['colorName']?>">
                </div>
...
<script>
    function submit() {
        ...
        $.ajax({
            url:"request/colorEdit.php",
            data:{
                id:'<?php echo $_GET['colorId'];?>',
