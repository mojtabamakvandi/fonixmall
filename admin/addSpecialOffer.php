        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="specialOfferPercentage" placeholder="درصدتخفیف">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">تاریخ انقضا</label>
                    <input type="date" class="form-control" id="specialOfferExpireDate" placeholder="تاریخ انقضا">
                </div>
...
<script>
    function submit() {
        ...
        var specialOfferPercentage = $("#specialOfferPercentage").val();
        var specialOfferExpireDate = $("#specialOfferExpireDate").val();
        $.ajax({
            url:"request/addSpOffer.php",
            data:{
                product:product,
                specialOfferPercentage:specialOfferPercentage,
                specialOfferExpireDate:specialOfferExpireDate,
            },
            dataType:'json',
            type:'POST',
            success:function (data) {
