...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">صندوق ورودی ایمیل</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-3">
                <a href="{{url('cp/sendmail')}}" class="btn btn-primary btn-block margin-bottom">ارسال ایمیل جدید</a>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="{{url('cp/mailbox')}}"><i class="fa fa-inbox"></i> صندوق ورودی
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">صندوق ورودی</h3>
