...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> محصولات هایپرمارکت</li>
        </ol>
    </section>
...
<div class="row">
                    ...
                    <tbody>
                        @foreach($products as $index => $product)
                            <tr>
                                ...
                                <td>{{ $product->fi_khales }}</td>
                                <td>{{ $product->fi_off }}</td>
                                <td>{{ $product->unit }}</td>
                                <td>{{ substr(verta($product->created_at),0,10) }}</td>
    ...
    <div class="modal modal-primary fade" id="modal-warning" style="display: none;">
        <div class="modal-dialog">
            <form action="{{ route('hp-import') }}" method="post" enctype="multipart/form-data">
                @csrf
