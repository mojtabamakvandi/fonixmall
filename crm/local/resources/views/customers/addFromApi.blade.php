...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">مشتریان هایپر مارکت</li>
        </ol>
    </section>
    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">همه مشتریان هایپر مارکت</h3>
                <div class="box-tools">
                    <button class="btn btn-xs btn-primary" type="button"  data-toggle="modal" data-target="#modal-warning">ورودی اکسل</button>
                    <a href="{{ route('customer-export') }}" class="btn  btn-xs btn-success">خروجی اکسل</a>
